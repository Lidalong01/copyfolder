...
<table width="752" border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
  ...
  <tr>
    <td height="25">评论的具体内容</td>
  </tr>
  <tr>
    <td height="25">评论时间：</td>
  </tr>
  <tr>
    <td height="1" bgcolor="#99FFFF"></td>
		  ...
		  <table width="95%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td height="25" colspan="2" align="center"><input type="hidden" name="blog_comm_tag" value="1"><input type="submit" name="Submit" value="发表评论" /></td>
            </tr>
          </table>
		  </form>
		  <!--End 评论内容 --></td>
